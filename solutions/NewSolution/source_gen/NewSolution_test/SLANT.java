...
public abstract class SLANT {
  ...
  public static void main(String[] args) {
    ...
    Reductions.initReduction(Reductions.Traversal.DFS, false, SLANT.inputBoardMapper(SLANT.inputLineNumb(SLANT.__(), SLANT.__(), SLANT.__(), SLANT._0(), SLANT.__()), SLANT.inputLineSlant(SLANT.x(), SLANT.x(), SLANT.x(), SLANT.x()), SLANT.inputLineNumb(SLANT.__(), SLANT._1(), SLANT._1(), SLANT._3(), SLANT._1()), SLANT.inputLineSlant(SLANT.x(), SLANT.f_slash(), SLANT.f_slash(), SLANT.b_slash()), SLANT.inputLineNumb(SLANT.__(), SLANT.__(), SLANT._2(), SLANT.__(), SLANT.__()), SLANT.inputLineSlant(SLANT.x(), SLANT.b_slash(), SLANT.b_slash(), SLANT.f_slash()), SLANT.inputLineNumb(SLANT.__(), SLANT._1(), SLANT._3(), SLANT.__(), SLANT._0()), SLANT.inputLineSlant(SLANT.f_slash(), SLANT.f_slash(), SLANT.b_slash(), SLANT.x()), SLANT.inputLineNumb(SLANT._1(), SLANT.__(), SLANT.__(), SLANT._1(), SLANT.__())));
