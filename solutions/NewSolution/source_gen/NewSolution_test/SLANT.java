...
public abstract class SLANT {
  ...
  public static Bool ArrowsBlockLeft(Block Block_43, Block Block_44, Block Block_45) {
    return new Bool(oper_ArrowsBlockLeft, Block_43, Block_44, Block_45);
  }
  public static Bool ArrowsBlockRight(Block Block_46, Block Block_47, Block Block_48) {
    return new Bool(oper_ArrowsBlockRight, Block_46, Block_47, Block_48);
  }
  public static Bool ArrowsBlockUp(Block Block_49, Block Block_50, Block Block_51) {
    return new Bool(oper_ArrowsBlockUp, Block_49, Block_50, Block_51);
  }
  public static Bool ArrowsBlockDown(Block Block_52, Block Block_53, Block Block_54) {
    return new Bool(oper_ArrowsBlockDown, Block_52, Block_53, Block_54);
  }
  public static Bool ArrowsLine(Line Line_21, Line Line_22, Line Line_23) {
    return new Bool(oper_ArrowsLine, Line_21, Line_22, Line_23);
  }

  /*package*/ static void initAxioms() {
    System.out.println("Using axioms of " + "SLANT");
    ITerm.axiom(SLANT.ArrowsLine(SLANT.mkLine(null, SLANT.b1, SLANT.b2, SLANT.b3, null), SLANT.mkLine(null, SLANT.b4, SLANT.b5, SLANT.b6, null), SLANT.mkLine(null, SLANT.b7, SLANT.b8, SLANT.b9, null)), BOOLEAN.And(BOOLEAN.And(BOOLEAN.And(BOOLEAN.And(BOOLEAN.And(BOOLEAN.And(BOOLEAN.And(SLANT.ArrowsBlockUp(SLANT.b2, SLANT.b4, SLANT.b6), SLANT.ArrowsBlockUp(SLANT.b5, SLANT.b7, SLANT.b9)), SLANT.ArrowsBlockDown(SLANT.b1, SLANT.b3, SLANT.b5)), SLANT.ArrowsBlockDown(SLANT.b4, SLANT.b6, SLANT.b8)), SLANT.ArrowsBlockLeft(SLANT.b2, SLANT.b4, SLANT.b8)), SLANT.ArrowsBlockLeft(SLANT.b3, SLANT.b5, SLANT.b9)), SLANT.ArrowsBlockRight(SLANT.b1, SLANT.b5, SLANT.b7)), SLANT.ArrowsBlockRight(SLANT.b2, SLANT.b6, SLANT.b8)));
    ...
    ITerm.axiom(SLANT.ArrowsBlockDown(SLANT.mkBlock(SLANT.s1, SLANT.s2, SLANT.n1, SLANT.s3, SLANT.s4), SLANT.mkBlock(SLANT.s5, SLANT.s6, SLANT.n2, SLANT.s7, SLANT.s8), SLANT.mkBlock(SLANT.s9, SLANT.s10, SLANT.n3, SLANT.s11, SLANT.s12)), BOOLEAN.And(BOOLEAN.And(BOOLEAN.Or(SLANT.doubleRight4(SLANT.s5, SLANT.s7, SLANT.n2, SLANT.s6, SLANT.s8), SLANT.doubleRight1(SLANT.s1, SLANT.s2, SLANT.n2, SLANT.s3, SLANT.s4)), BOOLEAN.Or(SLANT.doubleLeft2(SLANT.s4, SLANT.s2, SLANT.n1, SLANT.s3, SLANT.s1), SLANT.doubleLeft4(SLANT.s4, SLANT.s2, SLANT.n1, SLANT.s3, SLANT.s1))), BOOLEAN.Or(BOOLEAN.Or(BOOLEAN.Or(SLANT.triple4(SLANT.s9, SLANT.s10, SLANT.n3, SLANT.s11, SLANT.s12), SLANT.triple7(SLANT.s9, SLANT.s10, SLANT.n3, SLANT.s11, SLANT.s12)), SLANT.triple8(SLANT.s12, SLANT.s11, SLANT.n3, SLANT.s10, SLANT.s9)), SLANT.triple10(SLANT.s12, SLANT.s10, SLANT.n3, SLANT.s11, SLANT.s9))));
  ...
  public static void main(String[] args) {
    ...
    Reductions.initReduction(Reductions.Traversal.DFS, false, SLANT.ArrowsBlockDown(SLANT.mkBlock(SLANT.sf(), SLANT.sb(), SLANT.__(), SLANT.sb(), SLANT.sx()), SLANT.mkBlock(SLANT.sf(), SLANT.sb(), SLANT.__(), SLANT.sx(), SLANT.sf()), SLANT.mkBlock(SLANT.sx(), SLANT.sx(), SLANT.__(), SLANT.sb(), SLANT.sf())));
    ...
    Reductions.initReduction(Reductions.Traversal.DFS, false, 0, SLANT.inputBoard(SLANT.inputLineN(SLANT.__(), SLANT.__(), SLANT.__(), SLANT.__(), SLANT.__()), SLANT.inputLineX(SLANT.sf(), SLANT.sb(), SLANT.sf(), SLANT.sb()), SLANT.inputLineN(SLANT.__(), SLANT.__(), SLANT.__(), SLANT.__(), SLANT.__()), SLANT.inputLineX(SLANT.sb(), SLANT.sx(), SLANT.sx(), SLANT.sf()), SLANT.inputLineN(SLANT.__(), SLANT.__(), SLANT.__(), SLANT.__(), SLANT.__()), SLANT.inputLineX(SLANT.sf(), SLANT.sx(), SLANT.sx(), SLANT.sb()), SLANT.inputLineN(SLANT.__(), SLANT.__(), SLANT.__(), SLANT.__(), SLANT.__()), SLANT.inputLineX(SLANT.sb(), SLANT.sf(), SLANT.sb(), SLANT.sf()), SLANT.inputLineN(SLANT.__(), SLANT.__(), SLANT.__(), SLANT.__(), SLANT.__())));
