...
public abstract class SLANT {
  ...
  /*package*/ static void initAxioms() {
    ...
    ITerm.axiom(SLANT.checkBigLoop(SLANT.mkBlock(SLANT.s1, SLANT.s2, SLANT.n1, SLANT.s3, SLANT.s4), SLANT.mkBlock(SLANT.s5, SLANT.s6, SLANT.n2, SLANT.s7, SLANT.s8), SLANT.mkBlock(SLANT.s9, SLANT.s10, SLANT.n3, SLANT.s11, SLANT.s12), SLANT.mkBlock(SLANT.s13, SLANT.s14, SLANT.n4, SLANT.s15, SLANT.s16)), BOOLEAN.And(BOOLEAN.And(BOOLEAN.And(BOOLEAN.And(BOOLEAN.And(BOOLEAN.And(BOOLEAN.And(BOOLEAN.Equal(SLANT.s2, SLANT.sf()), BOOLEAN.Equal(SLANT.s3, SLANT.sf())), BOOLEAN.Equal(SLANT.s5, SLANT.sb())), BOOLEAN.Equal(SLANT.s8, SLANT.sb())), BOOLEAN.Equal(SLANT.s9, SLANT.sb())), BOOLEAN.Equal(SLANT.s12, SLANT.sb())), BOOLEAN.Equal(SLANT.s14, SLANT.sf())), BOOLEAN.Equal(SLANT.s15, SLANT.sf())));
  }
