...
public abstract class SLANT {
  ...
  /*package*/ static void initAxioms() {
    ...
    ITerm.axiom(SLANT.TwoLines(SLANT.mkLine(null, SLANT.b2, SLANT.b3, SLANT.b4, null), SLANT.mkLine(null, SLANT.b7, SLANT.b8, SLANT.b9, null)), BOOLEAN.Or(BOOLEAN.Or(BOOLEAN.Or(SLANT.TwoBlocksRight(SLANT.b2, SLANT.b8), SLANT.TwoBlocksRight(SLANT.b3, SLANT.b9)), SLANT.TwoBlocksLeft(SLANT.b4, SLANT.b8)), SLANT.TwoBlocksLeft(SLANT.b3, SLANT.b7)));
  ...
  public static void main(String[] args) {
    ...
    // Execute actions 
    Reductions.initReduction(Reductions.Traversal.DFS, false, SLANT.doubleRight4(SLANT.fs(), SLANT.bs(), SLANT.__(), SLANT.xs(), SLANT.fs()));
    Reductions.initReduction(Reductions.Traversal.DFS, false, SLANT.doubleRight4(SLANT.fs(), SLANT.xs(), SLANT.__(), SLANT.bs(), SLANT.fs()));

    Reductions.initReduction(Reductions.Traversal.DFS, false, SLANT.TwoLines(SLANT.mkLine(SLANT.mkBlock(SLANT.xs(), SLANT.xs(), SLANT.__(), SLANT.xs(), SLANT.xs()), SLANT.mkBlock(SLANT.fs(), SLANT.bs(), SLANT.__(), SLANT.xs(), SLANT.fs()), SLANT.mkBlock(SLANT.xs(), SLANT.xs(), SLANT.__(), SLANT.xs(), SLANT.xs()), SLANT.mkBlock(SLANT.xs(), SLANT.xs(), SLANT.__(), SLANT.xs(), SLANT.xs()), SLANT.mkBlock(SLANT.xs(), SLANT.xs(), SLANT.__(), SLANT.xs(), SLANT.xs())), SLANT.mkLine(SLANT.mkBlock(SLANT.xs(), SLANT.xs(), SLANT.__(), SLANT.xs(), SLANT.xs()), SLANT.mkBlock(SLANT.xs(), SLANT.xs(), SLANT.__(), SLANT.xs(), SLANT.xs()), SLANT.mkBlock(SLANT.fs(), SLANT.xs(), SLANT.__(), SLANT.bs(), SLANT.fs()), SLANT.mkBlock(SLANT.xs(), SLANT.xs(), SLANT.__(), SLANT.xs(), SLANT.xs()), SLANT.mkBlock(SLANT.xs(), SLANT.xs(), SLANT.__(), SLANT.xs(), SLANT.xs()))));


    Reductions.initReduction(Reductions.Traversal.DFS, false, SLANT.TwoBlocksLeft(SLANT.mkBlock(SLANT.fs(), SLANT.bs(), SLANT.__(), SLANT.bs(), SLANT.xs()), SLANT.mkBlock(SLANT.xs(), SLANT.bs(), SLANT.__(), SLANT.bs(), SLANT.fs())));
    Reductions.initReduction(Reductions.Traversal.DFS, false, SLANT.TwoBlocksRight(SLANT.mkBlock(SLANT.fs(), SLANT.bs(), SLANT.__(), SLANT.xs(), SLANT.fs()), SLANT.mkBlock(SLANT.fs(), SLANT.xs(), SLANT.__(), SLANT.bs(), SLANT.fs())));
